...
await eventLoop.Start(new List<EventDrivenWorkItem>{
    EventDrivenWorkItem.Create("a"),
    EventDrivenWorkItem.Create("b"),
    EventDrivenWorkItem.Create("c"),
    EventDrivenWorkItem.Create("d"),
    EventDrivenWorkItem.Create("e"),
    EventDrivenWorkItem.Create("f"),
    EventDrivenWorkItem.Create("g"),
    EventDrivenWorkItem.Create("h"),
    EventDrivenWorkItem.Create("i"),
    EventDrivenWorkItem.Create("j"),
});
